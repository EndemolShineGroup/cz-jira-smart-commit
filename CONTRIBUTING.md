...
- **Node 8 LTS:** `cz-jira-smart-commit` has a minimum Node version
...
``` bash
git clone https://github.com/EndemolShineGroup/cz-jira-smart-commit.git
...
We want to ensure that `cz-jira-smart-commit` is secure for everyone. If
