...
2. Check out and follow our Guidelines: https://github.com/EndemolShineGroup/cz-jira-smart-commit/blob/develop/CONTRIBUTING.md
...
***Version of `cz-jira-smart-commit` you're using***:
